  ...
  return (
    <footer className="mt-20 py-6 text-center text-gray-300 bg-transparent border-t border-pink-400/30">
      ...
      <div className="flex justify-center gap-6 text-xl">
        ...
        {/* (İstersen buraya GitHub veya Medium da ekleyebilirsin) */}
        {/* <a href="https://github.com/zeynepuguz" target="_blank" rel="noreferrer" title="GitHub" className="hover:text-gray-200 transition">
